...
import * as data from '../Employees/data.json';
        ...
        <CardBody>
          <Formik
            ...
            onSubmit={async (values,{resetForm}) => {
              ...
              this.account = values;
              console.log(values)
              firestore.updatePartner(this.props.data.id, values, this.addPartnerSuccess, this.unSuccess);
              resetForm(true);
            ...
            initialValues={{
              ...
              subdistrict: this.props.data.subdistrict,
