...
const columns = [
    ...
    {
        name: 'productPrice', groupBy: false, defaultFlex: 1, header: 'ราคาสินค้าต่อหน่วย', type: 'number', render: ({ value }) => {
            if (value == null) {
                return '-';
            }
            return value;
    ...
    {
        name: 'disCount', groupBy: false, defaultFlex: 1, header: 'ส่วนลด', type: 'number', render: ({ value }) => {
            if (value == null) {
                return '-';
            }
            return value;
    ...
    {
        name: 'summary', groupBy: false, defaultFlex: 1, header: 'ยอดรวม', editable: false, type: 'number', render: ({ value }) => {
            if (value == null) {
                return '-';
            }
            return value;
            ...
            <Container fluid={false} style={{ backgroundColor: 'while' }} >
                ...
                <Row style={{ height: 50 }}>
                    ...
                    <Col md={2} >
                        ...
                        <button onClick={(e) => { this.toggleModalImage(e, 'in'); e.preventDefault(); }} style={{ display: 'contents' }}>
                            <AiFillFileText color='#00A3FF' size={30} />
                        </button>
                    </Col>
                    <Col md={2} >
                        <Label>ใบเสร็จ: </Label>
                        <button onClick={(e) => { this.toggleModalImage(e, 'receipt'); e.preventDefault(); }} style={{ display: 'contents' }}>
                            <AiFillFileText color='#00A3FF' size={30} />
                        </button>
                    </Col>
                </Row>
                ...
                <Row style={{ marginTop: '20px' }}>
                    ...
                    <Col className="text-center text-md-right">
                        <Label > ยอดรวม: {this.state.sum} บาท</Label>
                    </Col>
                </Row>
                <Row style={{ height: 25 }}>
                    <Col >
