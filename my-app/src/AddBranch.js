...
class AddPartnerCompany extends React.Component {
  ...
  addPartnerSuccess = () => {
    ...
    this.sweetAlret("เสร็จสิ้น","เพิ่มข้อมูลสาขาแล้ว","success","ตกลง");
  }
                ...
                <div className="Content">
                    ...
                    <body className="APCBody">
                      <Card style={{width:'97%', alignSelf:'center', marginTop:20}}>
                        <h2 style={{marginTop:25, marginLeft:25}}>เพิ่มสาขา</h2>
                        <CardBody>
                          <Formik
                            ...
                            onSubmit={async (values,{resetForm}) => {
                              ...
                              this.account = values;
                              console.log(values)
                              firestore.addBranch(values, this.addPartnerSuccess, this.unSuccess);
                              resetForm(true);
                              ...
                              >
                                ...
                                <Form onSubmit={handleSubmit} onReset={(e) => { e.preventDefault(); this.setDefaultImageCrop(); handleReset(e); }}>
                                  ...
                                  <Row form>
                                    ...
                                    <Col md={6}>
                                      <FormGroup>
                                        <Label for="agentName">ชื่อตัวแทน</Label>
                                        <Input
                                          type="text"
                                          name="agentName"
                                          id="agentName"
